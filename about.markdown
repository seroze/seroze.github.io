...
This is a dev log — notes on whatever I'm building, breaking or reading about on a given day. These days that's mostly agents and mechanistic interpretability.
